/* =========================================================
   ARPAN CHRISTIAN — PORTFOLIO SCRIPT
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  /* ---------------------------------------------------
     3. STICKY HEADER STATE + SCROLL PROGRESS + SCROLL-TOP BTN
  --------------------------------------------------- */
  ...
  /* ---------------------------------------------------
     5. SCROLL REVEAL + SKILL BAR ANIMATION + STAT COUNTERS
        (single IntersectionObserver handles all three)
  --------------------------------------------------- */

  // Tag elements that should fade/slide in
  ...
  /* ---------------------------------------------------
     7. CONTACT FORM (front-end only — no backend wired up)
  --------------------------------------------------- */
  ...
  contactForm.addEventListener("submit", (e) => {
    ...
    // Placeholder success behaviour — wire this up to a real backend
    // (e.g. Formspree, EmailJS, or a custom API endpoint) to actually send mail.
